...
<form action="<%= request.getContextPath() %>/vendor/contact-info" method="post">
    ...
    <br><br>
    <label for="cp_alter_phoneNum">Alternate Phone Number:</label>
    ...
    <br><br>
    <label for="cp_communication_channel">Preferred Communication Channel:</label>
